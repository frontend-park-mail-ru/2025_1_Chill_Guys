...
export async function saveAddress(region: string, city: string, addressString: string, coordinate: string, label: string): Promise<AJAXErrors> {
    const response = await ajax.post("addresses", { region, city, addressString, coordinate, label });

...
class SellerFormPage extends Tarakan.Component {
    ...
    async handleSendRequest() {
        if (this.state.name && this.state.description) {
            const code = await sendRequest(this.state.name, this.state.description);
            ...
            <main className="seller-form-page">
                <div className="seller-form-page__content">
                    <div className="seller-form-page__content__title">
                        <div>
                            <img className="seller-form-page__content__title__icon" src={LogoIcon} alt="Логотип Базара" />
                            <div className="seller-form-page__content__title__header">
                                <h1 className="seller-form-page__content__title__header__h1">Заявка на продавца</h1>
                                <div className="seller-form-page__content__title__header__comment">
                                    Укажите данные компании
                                </div>
                            </div>
                        </div>
                        <Button className="seller-form-page__content__title__redirect" title="Вернуться на главную страницу" variant="text" onClick={() => router.navigateTo("/")} />
                    </div>
